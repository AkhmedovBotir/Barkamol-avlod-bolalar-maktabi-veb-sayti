...
export default function Statistic() {
    ...
    return (
        <>
            <footer>
                <Container>
                    <Row className="footer-content d-flex justify-content-between" xs={1} md={2}>
                        <Col className="content-left py-4 p-5">
                            <h2 className='fs-5 fw-bold'>BIZ HAQIMIZDA</h2>
                            <span className="fs-6">
                                O‘zbekiston Respublikasi Xalq ta’limi
                                vazirligi huzuridagi “Barkamol avlod”
                                respublika bolalar maktabi
                            </span>
                        </Col>
                        <Col className="content-right py-3 p-5 fff">
                            <h2 className='fs-5 fw-bold'>ALOQA</h2>
                            <div className="tels fs-6">
                                <div className="email">
                                    <div className='icon'>
                                    ...
                                    <a href="mailto:andijonvilbabm@gmail.com">andijonvilbabm@gmail.com</a>
                                </div>
                                <div className="tel">
                                    <div className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0z" fill="none" /><path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56-.35-.12-.74-.03-1.01.24l-1.57 1.97c-2.83-1.35-5.48-3.9-6.89-6.83l1.95-1.66c.27-.28.35-.67.24-1.02-.37-1.11-.56-2.3-.56-3.53 0-.54-.45-.99-.99-.99H4.19C3.65 3 3 3.24 3 3.99 3 13.28 10.73 21 20.01 21c.71 0 .99-.63.99-1.18v-3.45c0-.54-.45-.99-.99-.99z" /></svg>
                                    </div>
                                    <a href="tel:+998902101201">+998 90 210 12 01</a>
                                </div>
                                <div className="tel">
                                    <div className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0z" fill="none" /><path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56-.35-.12-.74-.03-1.01.24l-1.57 1.97c-2.83-1.35-5.48-3.9-6.89-6.83l1.95-1.66c.27-.28.35-.67.24-1.02-.37-1.11-.56-2.3-.56-3.53 0-.54-.45-.99-.99-.99H4.19C3.65 3 3 3.24 3 3.99 3 13.28 10.73 21 20.01 21c.71 0 .99-.63.99-1.18v-3.45c0-.54-.45-.99-.99-.99z" /></svg>
                    ...
                    <div className="copy">
                        <span className='copyright py-3'>
                            {year} - © BABM | Barkamol avlod bolalar maktabi. Barcha huquqlar himoyalangan. Sayt ishlab chiqish: Akhmedov Botir
                        </span>
